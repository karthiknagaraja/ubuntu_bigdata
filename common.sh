...
#Zeppelin
ZEPPELIN_VERSION= #Change this for new version
ZEPPELIN_ARCHIVE=zeppelin.tar.gz #Change this for new version
ZEPPELIN_DIR=incubator-zeppelin #Change this for new version
ZEPPELIN_MIRROR_DOWNLOAD=
